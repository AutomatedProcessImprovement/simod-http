...
ENV SIMOD_QUEUE_PENDING_ROUTING_KEY='requests.pending'
ENV SIMOD_QUEUE_RUNNING_ROUTING_KEY='requests.running'
ENV SIMOD_QUEUE_FAILED_ROUTING_KEY='requests.failed'
ENV SIMOD_QUEUE_SUCCEEDED_ROUTING_KEY='requests.succeeded'
